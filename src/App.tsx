...
import { greekMythologyTopic } from './data/greekMythology'
...
import { worldBridgesTopic } from './data/worldBridges'
  ...
  return (
    <div className="app">
      <Routes>
        ...
        <Route path="/kings-and-queens-of-britain" element={<JeopardyTriviaPage topic={britishMonarchsTopic} />} />
        <Route path="/chemistry" element={<JeopardyTriviaPage topic={chemistryTopic} />} />
        <Route path="/computer-history" element={<JeopardyTriviaPage topic={computerHistoryTopic} />} />
        ...
        <Route path="/world-bridges" element={<JeopardyTriviaPage topic={worldBridgesTopic} />} />
        <Route path="/world-history" element={<JeopardyTriviaPage topic={worldHistoryTopic} />} />
        <Route path="/world-islands" element={<JeopardyTriviaPage topic={worldIslandsTopic} />} />
      </Routes>
    </div>
  )
}
